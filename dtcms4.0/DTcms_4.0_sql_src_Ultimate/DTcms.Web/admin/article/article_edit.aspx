      ...
      <span class="Validform_checktip">点击浏览该信息自动+1</span>
        ...
        <div class="tab-content" style="display: none">
            <dl>
                <dt>方案组成</dt>
                <dd>
                    <asp:TextBox ID="txtCompositionscheme" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*最少2个字符最多100个字符</span>
                </dd>
            </dl>
            <dl>
                <dt>场地要求</dt>
                <dd>
                    <asp:TextBox ID="txtSiterequirements" runat="server" MaxLength="100" datatype="*2-100" CssClass="input normal" />
                    <span class="Validform_checktip">*最少2个字符最多100个字符</span>
                </dd>
            </dl>
             <dl>
                <dt>费用预算</dt>
                <dd>
                    <asp:TextBox ID="txtCostbudget" runat="server" MaxLength="100" datatype="*2-100" CssClass="input normal" />
             ...
             <dl>
                <dt>展期</dt>
                <dd>
                    <asp:TextBox ID="txtExhibitiontime" runat="server" MaxLength="100" datatype="*2-100" CssClass="input normal" />
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
             <dl>
                <dt>资源联系人</dt>
                <dd>
                    <asp:TextBox ID="txtResourcelinkage" runat="server" MaxLength="100" datatype="*2-100" CssClass="input normal" />
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
             <dl>
                <dt>联系人电话</dt>
                <dd>
                    <asp:TextBox ID="txtResourcephone" runat="server" MaxLength="11" datatype="*2-100" CssClass="input normal" />
