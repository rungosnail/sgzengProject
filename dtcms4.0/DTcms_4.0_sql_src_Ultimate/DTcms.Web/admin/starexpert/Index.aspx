<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="DTcms.Web.admin.starexpert.Index" %>
                ...
                <ItemTemplate>
                    <li>
                        <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
                            ...
                            <h1><span><a href="Edit.aspx?channel_id=<%=channel_id %>&id=<%#Eval("id") %>"><%#Eval("name")%> <%#Eval("job_occupation")%></a></span></h1>

                            <div class="tools">
                            </div>
                            <div class="foot">
                                <p class="time"><%#string.Format("{0:yyyy-MM-dd HH:mm:ss}", Eval("createdate"))%></p>
                                <a href="Edit.aspx?channel_id=<%=channel_id %>&id=<%#Eval("id") %>" title="编辑" class="edit">编辑</a>
                            </div>
                        </div>
                    </li>
                </ItemTemplate>
